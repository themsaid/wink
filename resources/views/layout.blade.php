...
<head>
    ...
    <!-- Icon-->
    <link rel="icon" type="image/png" href="{{asset('/vendor/wink/favicon.png')}}"/>
    ...
    @if(@auth('wink')->user()->meta['theme'] == 'dark')
        <link href='{{asset(mix('dark.css', 'vendor/wink'))}}' rel='stylesheet' type='text/css'>
        <link rel="stylesheet" href="//cdn.jsdelivr.net/gh/highlightjs/cdn-release@9.13.1/build/styles/sunburst.min.css">
    @else
        <link href='{{asset(mix('light.css', 'vendor/wink'))}}' rel='stylesheet' type='text/css'>
...
<script src="{{asset(mix('app.js', 'vendor/wink'))}}"></script>
</body>
</html>
