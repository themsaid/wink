...
class TeamController
{
    ...
    public function store($id)
    {
        ...
        validator($data, [
            ...
            'name' => 'required',
            'slug' => 'required|'.Rule::unique(config('wink.database_connection').'.wink_authors', 'slug')->ignore(WinkAuthor::find(request('id'))),
            'email' => 'required|email|'.Rule::unique(config('wink.database_connection').'.wink_authors', 'email')->ignore(WinkAuthor::find(request('id'))),
        ])->validate();
